...
Deve iniciar o cadastro do cliente com sucesso
    ...
    Fill Text    //input[contains(@placeholder,'Nome completo')]       ${account}[name]
    Fill Text    //input[contains(@placeholder,'Seu melhor email')]    ${account}[email]
    Fill Text    //input[contains(@placeholder,'CPF (somente dígitos)')]   ${account}[document]
